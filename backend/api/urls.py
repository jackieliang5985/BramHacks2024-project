...
from .views import find_stops_in_danger_tract_view, find_wards_view, all_wards_view, estimated_buses_view
...
urlpatterns = [
    ...
    path("estimated-buses/", estimated_buses_view, name="estimated_buses"),
]